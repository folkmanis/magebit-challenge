        ...
        no-underline hover:no-underline font-title" href="#" title="" aria-label="store logo">
                        ...
                        <nav class="w-full duration-150 ease-in-out transform flex justify-start w-auto relative min-h-0 transition-display">
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="What's New">WHAT'S NEW</a>
                                </span>
                            </div>
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="Women">WOMEN</a>
                                </span>
                            </div>
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="Men">MEN</a>
                                </span>
                            </div>
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="Gear">GEAR</a>
                                </span>
                            </div>
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="Training">TRAINING</a>
                                </span>
                            </div>
                            <div class="relative mr-2 level-0">
                                <span class="flex items-center block p-3 text-md bg-opacity-95">
                                    <a data-test="header-link" class="w-full py-3 text-base text-gray-700 hover:underline level-0" href="#" title="Sale">SALE</a>
                                </span>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="flex items-center order-3">
                    ...
                    <div class="relative inline-block ml-1 sm:ml-3">
                        <a data-test="header-icon" href="#" id="customer-menu" class="block hover:text-black" aria-label="My Account" aria-expanded="false">
                    ...
                    <!--Cart Icon-->
                    <a data-test="header-icon" id="menu-cart-icon" class="relative inline-block ml-1 no-underline sm:ml-3 hover:text-black" href="#">
